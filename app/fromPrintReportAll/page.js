...
import HeaderFromPrintReportAll from '@/components/FromPrintReportAll/HeaderFromPrintReportAll'
import Print_FromPrintReportAll from '@/components/FromPrintReportAll/Print_FromPrintReportAll'
        ...
        <Baselayout>
            <div id='top' className='w-full h-full bg-[#FFFFFF] p-4 px-20  pb-20  '>
                ...
                <div className='flex justify-start mb-4'>
                    <label className='font-semibold text-[#2F2F2F] text-3xl' htmlFor="">FromPrintReportAll</label>
                </div>
                <div className='w-full flex justify-between'>
                    <div className='w-[50%] flex flex-col'>
                        <HeaderFromPrintReportAll setvalues={(v) => setvalues(v)} values={values} meta={options} excelexport={excelexport} />
                    </div>
                    <div className='w-[50%] flex flex-col'>
                        <div className='flex justify-center mb-2'>
                            <label className='font-semibold text-[#2F2F2F] text-2xl' htmlFor="">พิมพ์รายงาน ตามบริษัทหรือวันที่</label>
                        </div>
                        <Print_FromPrintReportAll data={form} refresh={refresh} values={values} setExcelExport={setExcelExport} />
                    </div>
                </div>
