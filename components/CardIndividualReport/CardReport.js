...
function CardReport({ data }) {
    ...
    return (
        <div className='w-full flex justify-center'>
            <div className='flex w-full gap-2 bg-[#F3F3F3] p-4 rounded-lg border-[#F3F3F3] border'>
                <div className='w-1/12'>
                    <img src={'/images/manreport.jpg'} alt="" />
                </div>
                <div className='w-6/12 flex flex-col items-start text-base h-full p-2'>
                ...
                <div className='w-5/12 min-w-[300px] flex flex-col gap-4'>
                    <div className='cursor-pointer relative p-4 flex h-20 items-center shadow-button-cardInformation bg-[#FFFFFF] rounded-lg border-[#F8F8F8] border gb-[#FFFFFF]'>
                        <label className='w-1/6 md:w-[50%] lg:w-[40%] font-semibold whitespace-nowrap cursor-pointer text-[#FF1921]'>การแพ้ยา</label>
                        <label className='whitespace-nowrap cursor-pointer text-[#FF1921]'>{data?.allergies || '-'}</label>
                    </div>
                    <div className='w-full cursor-pointer relative p-4 flex h-20 items-center shadow-button-cardInformation bg-[#FFFFFF] rounded-lg border-[#F8F8F8] border gb-[#FFFFFF]'>
                        <label className='w-1/6 md:w-[70%] lg:w-[40%]  font-semibold whitespace-nowrap cursor-pointer text-[#FF1921]'>โรคประจำตัว</label>
