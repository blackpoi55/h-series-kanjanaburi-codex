...
export const ModalReportEdit = (props) => {
    ...
    const header = [{ value: '51', label: 'Hematology ' },
    { value: '52', label: 'Blood Sugar' },
    { value: '54', label: 'Kidney Function Test' },
    { value: '56', label: 'Liver Function Test' },
    { value: '53', label: 'Lipid Profile' },
    { value: '55"', label: 'Uric acid Test' },
    { value: '59', label: 'Urine Analysis' },
    { value: '99', label: 'Toxicology' },
    { value: '57', label: 'Tumor marker' },
    ]
        ...
        <ModalComponent onCancel={() => props.onClose()} onSave={() => onSave()} headname={`แก้ไขข้อมูล Report`} classheadname={'text-[#365382]'} setIsModal={() => props.onClose()} isModal={data != null} modalsize={'w-[90%]  h-[90%] '}>
            <div className=" overflow-auto w-full h-full px-4 pb-4 gap-4 flex flex-col">
                <div className='grid grid-cols-12 w-full gap-4 justify-start items-start rounded-2xl bg-[#F8F8F8] shadow-box p-4 mt-2'>
                    ...
                    <div className='flex flex-col gap-1 col-span-6'>
                        <p className='text-sm text-[#365382]'> Pulse rate Detail</p>
                    ...
                    <div className='flex flex-col gap-1 col-span-6'>
                        <p className='text-sm text-[#365382]'>Waistline</p>
                    ...
                    <div className='flex flex-col gap-1 col-span-6'>
                        <p className='text-sm text-[#365382]'> Physical Examination</p>
                        ...
                        return <div key={`${f?.value}${index}`} className='grid grid-cols-12 w-full gap-4 justify-start items-start rounded-2xl bg-[#F8F8F8] shadow-box p-4 mt-2'>
                            <div className='  grid grid-cols-12 col-span-12 '>
                                ...
                                <div className='flex col-span-3 gap-4 items-end  '>
                                    ...
                                    <label className='font-semibold w-full text-center'>Checklist</label>
                                </div>
                                <label className='font-semibold col-span-2 text-center'> Result </label>
                                <label className='font-semibold col-span-2 text-center'> Normal Value </label>
                ...
                <div className='grid grid-cols-12 w-full gap-4 justify-start items-start rounded-2xl bg-[#F8F8F8] shadow-box p-4 mt-2'>
                    <div className='flex text-[#365382] justify-between col-span-12 '>
                        <label className='font-semibold'>Additional Conclusion and Recommendation</label>
                    </div>
