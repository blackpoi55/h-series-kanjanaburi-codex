export const Sheetx = async (companyName,name, data, workbook) => {
        ...
        for (let index = 0; index < data.length; index++) {
            ...
            worksheet.addRow({
                ...
                col5: getdata.EmpID || '-',
                col6: getdata.Dept || '-',
                col7: getdata?.trXrayFromSSBs?.[0]?.Description || '-',
                col8: getdata?.trXrayFromSSBs?.[0]?.HSeriesResultDetail || '-',
                col9: getdata?.trXrayFromSSBs?.[0]?.XrayStatus || '-'
            });
        }
