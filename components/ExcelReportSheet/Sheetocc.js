export const Sheetocc = async (companyName,name, data, workbook) => {
        ...
        for (let index = 0; index < data.length; index++) {
            ...
            worksheet.addRow({
                ...
                col5: getdata.EmpID || "-",
                col6: getdata.Dept || "-",
                col7: getdata.SpiroDetail || '-',
                col8: getdata.titmusdetail || '-',
                col9: getdata?.LeftEarDetail || '-',
                col10: getdata?.RightEarDetail || '-',
                col11: getdata.AudioDetail || '-',
                col12: getdata.VPDetail || '-', 
            });
        }
